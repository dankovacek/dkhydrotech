...
#   credentials, it will be store in C:\Users\user\.credentials)
...
def get_credentials():
    ...
    if not credentials or credentials.invalid:
        CLIENT_SECRET_FILE = os.path.join(KEY_DIR, 'gmail_secret.json')
        APPLICATION_NAME = 'django-frazil'
...
def create_message_and_send(sender, to, subject,  message_text_plain, message_text_html, attached_file):
    ...
    # send_Message_without_attachement(
...
def main():
    to = "dankovacek@gmail.com"
    sender = "dankovacek@dkhydrotech.com"
    subject = "subject test1"
    message_text_html = r'Hi<br/>Html <b>hello</b>'
    message_text_plain = "Hi\nPlain Email"
    attached_file = '/home/danbot/Music/downloads/Going_to_the_West.mp3'
