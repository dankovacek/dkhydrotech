...
<p>In other words, if each pixel can take one of 256 values, and there are {original_dims[0]} x {original_dims[1]} = {n_pixels:,} pixels, the number of possible <em>unique</em> images is {n_pixels:,}<sup>256</sup>, or roughly <strong>10<sup>262</sup></strong>.  As a hopelessly inadequate basis of comparison, the <a href="https://physics.stackexchange.com/questions/47941/dumbed-down-explanation-how-scientists-know-the-number-of-atoms-in-the-universe">cosmological estimate of the number of <strong>atoms in the universe is about 10<sup>80</sup></strong></a>.  The set of all {original_dims[0]} x {original_dims[1]} pixel images that humans can recognize is <strong>effectively zero</strong>.  Virtually every arrangement looks like <a href="https://www.youtube.com/watch?v=Un8yRBC84Yk">static on an old CRT TV</a>.</p>
